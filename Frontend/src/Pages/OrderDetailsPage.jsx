...
const OrderDetailsPage = () => {
    ...
    useEffect(() => {
        const mockOrderDetails = {
            ...
            shippingMethode: "standerd",
            shippingAddress: {city: "Kannur", country:"India"},
            orderItems: [
                {
                    productId: "1",
                    name: "Jacket",
  ...
  return (
    <div className='max-w-7xl mx-auto p-4 sm:p-6'>
        <h2 className='text-2xl md:text-3xl font-bold mb-6'>Order Dtails</h2>
                        ...
                        <tbody>
                            {orderDetails.orderItems.map((item) => (
                                <tr key={item.productId} className='border-b'>
                                    ...
                                    <td className="py-2 px4">₹{item.price}</td>
                                    <td className="py-2 px4">{item.quantity}</td>
                                    <td className="py-2 px4">₹{item.price * item.quantity}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
