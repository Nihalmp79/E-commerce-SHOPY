...
const EditProductPage = () => {
    ...
    const handleChange = (e) =>{
        ...
        setProductData((pervData) => ({...pervData, [name]: value}));
    }
    ...
    <div className='max-w-5xl mx-auto p-6 shadow-md rounded-md'>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6">
            ...
            <textarea name="description" onChange={handleChange} value={productData.description} className='w-full border border-gray-300 rounded-md p-2' rows={4} required/>
        </div>
        {/* Price */}
        <div className='mb-6'>
        ...
        <div className='mb-6'>
            ...
            <input type="number" onChange={handleChange} name='countInStock' value={productData.countInStock} onChange={handleChange} className='w-full border border-gray-300 rounded-md p-2' />
        </div>
        {/* SKU */}
        <div className='mb-6'>
        ...
        <div className='mb-6'>
            ...
            <input type="text" name='size' value={productData.sizes.join(", ")} onChange={(e) => setProductData({...productData, sizes: e.target.value.split(",").map((size) => size.trim())}) } className='w-full border border-gray-300 rounded-md p-2' />
        </div>
         {/* colors */}
        <div className='mb-6'>
