    ...
    <section className='py-16 px-4 lg:px-0 m-10'>
        <div className='container mx-auto flex flex-col-reverse lg:flex-row items-center bg-green-50 rounded-3xl'>
            ...
            <div className='lg:w-1/2 p-8 text-center lg:text-left'>
                <h2 className='tex-lg font-semibold text-gray-700 mb-2'>
                    Comfort and Style
                </h2>
            ...
            <div className='lg:w-1/2'>
                <img src={featured} alt="Featured Collections" className='w-full h-full object-cover lg:rounded-tr-3xl lg:rounded-br-3xl' />
            </div>
        </div>
    </section>
  )
